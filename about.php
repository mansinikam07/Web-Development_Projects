...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="css/s3.css" rel='stylesheet' type='text/css' /><!-- custom css -->
...
<header>
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			<div id="logo">
				<h1 class="mt-md-0 mt-2"> <a href="about.php"><span class=""></span> Railway Management System</a></h1>
			</div>
	...
	<div class="container py-lg-5 py-sm-4">
		<div class="row">
			<div class="col-lg-6 about-left">
				<h3 class="mt-lg-3">We will take you to the Top destination in the India, <strong>Explore with us!</strong></h3>
				<p class="mt-4">Our mission is simple yet profound: to inspire and facilitate unforgettable railway adventures. We believe that the magic of a journey lies in the moments experienced along the way. We aim to create those moments for you and turn each trip into a tale worth telling.</p>
				<p class="mt-3">Our team comprises railway enthusiasts and experts who know the ins and outs of rail travel. We live and breathe the world of trains, and this passion translates into the experiences we offer.</p>
			</div>
			<div class="col-lg-6 about-right text-lg-right mt-lg-0 mt-5">
				<img src="images/k8.jpg" alt="" class="img-fluid abt-image" />
			</div>
		</div>
						...
						<div class="row text-center">
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									<span class=""></span>
									<h4 class="mt-md-4 mt-2">Convenience</h4>
									<p class="mt-3">Trains often connect major cities and regions, making it a convenient mode of transportation for both short and long distances. </p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									<span class=""></span>
									<h4 class="mt-md-4 mt-2">Comfort</h4>
									<p class="mt-3"> Modern trains offer comfortable seating, ample legroom, and the ability to move around during the journey.</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 inner-w3pvt-wrap">
								<div class="inner-sec-grid">
									<span class=""></span>
									<h4 class="mt-md-4 mt-2">Cost-Effective</h4>
									<p class="mt-3">In some cases, train tickets can be more affordable than plane tickets for the same distance,if booked in advance or for shorter journeys.</p>
								</div>
							</div>
						</div>
					</section>
